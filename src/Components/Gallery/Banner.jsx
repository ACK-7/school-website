      ...
      <div className="relative z-20 flex items-center h-full px-8 md:px-20">
        <div className="max-w-2xl text-white space-y-6">
          <h1 className="banner-title text-4xl md:text-6xl font-bold leading-tight">
            School Gallery<br />A Glimpsse into<br />Our Vibrant Life
          </h1>
          <p className="banner-text text-gray-300">
            we invite you to explore our gallery showcasing the dynamic spirit of seeta schools — from classroom moments and cultural events to sports, celebrations, and day-to-day life. each image reflects our commitment to excellence, community, and holistic development.
          </p>
        </div>
      </div>
