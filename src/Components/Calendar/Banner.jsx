      ...
      <div className="relative z-20 flex items-center h-full px-8 md:px-20">
        <div className="max-w-2xl text-white space-y-6">
          <h1 className="banner-title text-4xl md:text-6xl font-bold leading-tight">
            Seeta Schools<br />Academic Calendar<br />At Glance
          </h1>
          <p className="banner-text text-gray-300">
            we are committed to keeping our students, parents, and staff informed with a clear and well-structured academic calendar that outlines important dates, term schedules, examinations, holidays, and school events to support effective planning and academic success.
          </p>
        </div>
      </div>
