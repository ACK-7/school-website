      ...
      <div className="relative z-20 flex items-center h-full px-8 md:px-20">
        <div className="max-w-2xl text-white space-y-6">
          <h1 className="banner-title text-4xl md:text-6xl font-bold leading-tight">
            Seeta Schools<br />Where Interests<br />Spark Growth
          </h1>
          <p className="banner-text text-gray-300">
           we foster a vibrant co-curricular life through diverse clubs that encourage creativity, leadership, teamwork, and personal development. our students explore passions, build friendships, and grow into confident, well-rounded individuals.
          </p>
        </div>
      </div>
